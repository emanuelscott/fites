...
<nav className="bg-gradient-to-r from-[#D80000] via-[#2B2B2B] to-black ">
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse font-oswald">
      ...
      <button type="button" className="w-[115px] text-black bg-white text-[16px] px-4 py-2 text-center mr-20 hover:bg-[#BF0A0A] hover:text-white">CONTACT</button>
      </a>     
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul className="flex flex-col font-oswald p-4 md:p-0 mt-4 border xl:space-x-20 md:space-x-14 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
      <li>
