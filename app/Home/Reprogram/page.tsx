...
const Reprogram = () => {
  return (
   <main className='2xl:w-screen 2xl:h-[390px] xl:w-screen xl:h-[320px] sm:w-[1150px] sm:h-[300px] bg-black mx-auto'>
    <img src="./line9.png" className="min-w-screen "/>

    <div className='flex flex-row flexCenter mt-5'>
        <p className='text-white 2xl:text-[38px] sm:text-[32px] lg:text-[30px] xl:text-[38px] font-medium uppercase '>
        Reprogram for
        </p>
    <p className='text-[#D80000] 2xl:text-[38px] sm:text-[32px]  lg:text-[30px] xl:text-[38px] font-medium uppercase ml-2'>
        Success
        </p>
    </div>
