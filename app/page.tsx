...
export default function Home() {
    ...
    <meta name="description" content=" At Emanuel Scott Fitness, we believe that greatness lies within each of us. Our mission is to empower you to discover your inner strength and achieve the extraordinary. We embrace the whole person concept, recognizing that true fitness begins with the physical and transcends to encompass spiritual, mental, emotional, social, and financial well-being. By guiding you into your destiny and serving your higher purpose, we support you through every step of your transformative journey." />
  ...
  return (
   ...
   <div className="border border-black bg-black h-[132px] sm:w-[327px] sm:h-[150px] md:w-[500px] xl:w-[600px] 2xl:w-[700px]  "> 
    ...
    <a href="/Contact">
    <button type="button" className="flex flexCenter sm:ml-20 font-oswald text-white bg-[#BF0A0A] font-medium 2xl:text-[16px] xl:text-[16px] sm:text-[16px] px-4 py-2 text-center mr-20 sm:mt-10 w-[200px] h-[60px] ">LET'S START NOW</button>
    </a>

    </div>

    
      <img src="./homelanding.png" className="2xl:h-[667.37px] 2xl:w-screen xl:w-screen xl:h-[667.37px] sm:w-[0px] sm:h-[0px] "/>
    <img src='./mobilehome.png' className="2xl:invisible xl:invisible sm:visible"/>
