  ...
  return (
   ...
   <div className="border border-black bg-black  h-[132px] sm:w-[250px] sm:h-[150px] md:w-[500px] xl:w-[600px] 2xl:w-[700px]  "> 
    ...
    <div className="flex flex-row ">
      <img src="./homelanding.png" className="2xl:h-[667.37px] 2xl:w-screen xl:w-screen xl:h-[667.37px] sm:w-[450px] sm:h-[450px] "/>
    ...
    <div className="flex flex-col text-center gap-y-2 bg-black">
        <h1 className="text-[#D80000] 2xl:text-[38px] sm:text-[12px] md:text-[16px] lg:text-[30px] xl:text-[38px] font-medium uppercase">
