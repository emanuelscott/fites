...
export default function Home() {
  ...
  return (
   ...
   <main className="2xl:w-screen xl:w-screen h-screen bg-black sm:w-[1150px] mx-auto ">
      
    <div className="flex flex-col ">
    <div className="flex flex-row flexCenter ">
    <div className="flex flex-col 2xl:ml-36 sm:ml-10 md:ml-10 lg:ml-20 xl:ml-28">
    ...
    <p className="font-semibold font-oswald bg-gradient-to-r from-[#FFFFFF] to-[#999999] inline-block text-transparent bg-clip-text 2xl:text-[78px] sm:text-[32px] md:text-[48px] lg:text-[64px]">
      EMANUEL SCOTT
      </p>
      <p className="font-semibold font-oswald bg-gradient-to-r from-[#FFFFFF] to-[#999999] inline-block text-transparent bg-clip-text 2xl:text-[78px] sm:text-[32px] md:text-[48px] lg:text-[64px]">
      FITNESS & COACH
   ...
   <div className="border border-black bg-black  h-[132px] sm:w-[250px] sm:h-[150px] md:w-[500px] xl:w-[600px] 2xl:w-[700px]  "> 
    <article className="text-balance text-[#ECECEC] text-[16px] sm:text-[14px] md:text-[12px] lg:text-[16px] xl:text-[16px] font-oswald font-extralight">
      <p>
    ...
    <a href="/Contact">
    <button type="button" className="font-oswald text-white bg-[#BF0A0A] font-medium 2xl:text-[16px] xl:text-[16px] sm:text-[16px] px-4 py-2 text-center mr-20 sm:mt-20 w-[200px] h-[60px] ">LET'S START NOW</button>
    </a>

    </div>

    
      <img src="./homelanding.png" className="2xl:h-[667.37px] 2xl:w-screen xl:w-screen xl:h-[667.37px] sm:w-[650px] sm:h-[550px] "/>
    ...
    <div className="flex flex-col text-center gap-y-2 bg-black">
        <h1 className="text-[#D80000] 2xl:text-[38px] sm:text-[24px] md:text-[16px] lg:text-[30px] xl:text-[38px] font-medium uppercase">
        Are You Stuck in Survival Mode?
        </h1>

        <div className="flex flex-row flexCenter mt-4 2xl:text-[22px] sm:text-[16px] md:text-[16px] lg:text-[22px] xl:text-[22px]">
            ...
            unable to maintain momentum?           
             ...
             <div className="flex flex-row flexCenter 2xl:text-[22px] sm:text-[16px] md:text-[16px] lg:text-[22px] xl:text-[22px]">
            <span className="text-white font-light">
            ...
            yes        
             ...
             <img src="./landingline.png" className="2xl:w-screen h-[81px] xl:w-screen sm:w-[1150px] "/>
