    ...
    fill="white">
      <path
        ...
        <div className='ml-10'>
            ...
            <ul className="text-[#D5D5D5] font-light uppercase font-oswald">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Sculpt & Tone Program</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Glute Maximizer Program</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Waist Wellness Program</a>
                </li>
            </ul>
        </div>
        ...
        <div className='ml-10'>
            ...
            <ul className="text-[#D5D5D5] font-light uppercase font-oswald">
                <li className="mb-4">
                    <a href="#" className="hover:underline">Peak Performance Program</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Endurance Elite Program</a>
                </li>
                <li className="mb-4">
                    <a href="#" className="hover:underline">Cardio Blitz Program</a>
                </li>
            </ul>
        </div>
