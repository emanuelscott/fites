...
const Customer = () => {
  return (
    <main className='bg-white w-screen h-[600px] '>
   ...
   <img src='./stars.png' className='mt-4'/>
      ...
      Emanuel Scott Fitness transformed my body! I never thought I could achieve such amazing results. The Glute Maximizerr program was a game-changer for me
      </span>  
