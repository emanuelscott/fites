...
const Blog = () => {
  ...
  return (
   <main className='bg-black 2xl:w-screen 2xl:h-[840px] xl:w-screen xl:h-[840px] sm:w-[800px] sm:h-[1800px]'>
    ...
    sm:ml-6 2xl:invisible xl:invisible lg:invisible sm:visible">
        explore all blogs
  </button>
    </a>
        </div>
