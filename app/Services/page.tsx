  ...
  return (
    <main className='w-screen min-h-screen bg-black '>
      ...
      <div className='flex flex-row text-[48px] font-medium uppercase flexCenter '>
         ...
         <p className='text-[#D80000] ml-2 mt-16'>
          service
         </p>
      </div>
...
<div className='box text-white bg-[#0C0C0C] w-[307px] h-[480px] flex flex-col '>
  ...
  <div className='flex flex-row items-center '>
      ...
      <p className='text-[18px] font-light ml-2 mt-5 text-balance'>
...
<div className='box text-white bg-[#0C0C0C] w-[307px] h-[480px] flex flex-col gap-y-1'>
  <img src='./muscle.png' className='w-[60px] h-[60px] mt-5 ml-10'/>
...
<div className='box text-white bg-[#0C0C0C] w-[307px] h-[480px] flex flex-col space-y-1'>
